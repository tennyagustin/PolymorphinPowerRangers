...
*/
    ...
    public int drawCard() {
        if (((WarPlayer) gamePlayers.get(0)).hand[0] != null) {
            ...
            System.out.print(((WarPlayer) gamePlayers.get(0)).name);
            ((WarPlayer) gamePlayers.get(0)).hand[0].printCard();
        } else {
        ...
        if (((WarPlayer) gamePlayers.get(1)).hand[0] != null) {
            ...
            System.out.print(((WarPlayer) gamePlayers.get(1)).name);
            ((WarPlayer) gamePlayers.get(1)).hand[0].printCard();
        } else {
    ...
    public void adjustHands() {
        ...
        for (i1 = 1; i1 < d.numberOfCards; i1++) {
            if (Player1.hand[i1] != null) {
                ...
                Player1.hand[--i1] = null;
                break;
            }
        }

        for (i2 = 1; i2 < d.numberOfCards; i2++) {
            if (Player2.hand[i2] != null) {
                Player2.hand[i2 - 1] = Player2.hand[i2];
            } else {
                Player2.hand[--i2] = null;
                break;
            }
        }
